...
- **物品图鉴**：2861 种物品按分类浏览，五维属性（饱食/心态/精力/健康/生命）、品质对比（完美/优良/普通/失败）、保鲜与变质链
- **配方图鉴**：496 道烹饪配方（含标签组合菜谱）+ 145 条制作配方，设施/等级反查
- **家具图鉴**：1246 件家具（功能按钮、电气参数、对应包裹物品互链）
- **Buff / 天赋图鉴**：757 条 Buff（含过期惩罚反查）、453 个天赋逐级效果
...
数据提取自游戏配置表（游戏版本 1.0.14754），页面不包含任何游戏美术资源。非官方资料站，仅供参考；数据如与游戏内不符，以游戏为准。
